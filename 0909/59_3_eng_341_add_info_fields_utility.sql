...
IF NOT EXISTS (SELECT TOP 1 1 FROM _tb_one_time_scripts_release_log WHERE script_name = '59_3_eng_341_add_info_fields_utility')
	...
	begin
		...
		declare @info_field_after_name_1 nvarchar(100) = 'GF_BUT_Previous_total_bonus_N1' -- info field, after which new columns 1 is added
		declare @info_field_after_name_2 nvarchar(100) = 'GF_BUT_Previous_total_bonus_N2' -- info field, after which new columns 2 is added
	...
	, 	('2', @template_name, @table_column_name_2, @info_field_name_2, '0', '0', '#NULL#', '1', '#NULL#', '#NULL#', '140', '#NULL#', '#NULL#', '#NULL#', '#NULL#', '20', '#NULL#', '#NULL#', '0', '#NULL#', '0', '1', '2', '#NULL#', '0', 'right', '0', '1', '#NULL#', '#NULL#', '#NULL#', '#NULL#', '#NULL#', '#NULL#', '1', '#NULL#', '#NULL#', '0', '0', '0', '0', '#NULL#', '#NULL#')
		...
		VALUES ('59_3_eng_341_add_info_fields_utility',GETUTCDATE());
