...
begin 	
	...
	begin		
		...
		select			person_id						= team_data.person_id
					...
					,	duration_month					= es.contract_duration_month
					,	renewal_flag					= 0
					,	focus_factor					= null
					,	b.booster
		...
		outer apply
			(select iif(es.profit_center_name = 'EOF' and isnull(es.order_entry_system_name, '') <> 'ESBA', @eof_type, @sbp_type) as eof_sbp) t10
